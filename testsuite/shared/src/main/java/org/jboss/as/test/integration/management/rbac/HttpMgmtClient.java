 ...
 */
public class HttpMgmtClient extends AbstractMgmtClient implements MgmtClient {
    public static final String MANAGEMENT_REALM = "ManagementRealm";

    private final URI uri;
    private final HttpClient httpClient;

    public HttpMgmtClient(String uriScheme, String host, int port, String username, String password) {
        try {
    ...
    public ModelNode execute(ModelNode operation) {
        ...
        System.out.println("Request operation: " + operationJson);
        try {
            ...
            ModelNode nodeResponse = parseResponse(response);
            return nodeResponse;
        } catch (IOException e) {
            throw new RuntimeException(e);
        }
    ...
    public static MgmtClient create(String host, int port, String username, String password) {
        return new HttpMgmtClient("http", host, port, username, password);
    }

    public static MgmtClient createSecure(String host, int port, String username, String password) {
        return new HttpMgmtClient("https", host, port, username, password);
    }
}